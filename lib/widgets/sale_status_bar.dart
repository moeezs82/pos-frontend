...
/// Compact status strip at the top of the Create Sale screen.
///
...
class _SaleStatusBarState extends State<SaleStatusBar> {
  // ── Clock ────────────────────────────────────────────────────────────────
  late DateTime _now;
  Timer? _clock;
...
class _PendingBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Tooltip(
      message: '$count sale${count == 1 ? '' : 's'} pending sync',
      child: Container(
