...
class VendorService {
  ...
  Future<Map<String, dynamic>> getUnallocatedCredit({required int vendorId}) async {
    return await _client.get('/vendors/$vendorId/unallocated-credit');
  }
